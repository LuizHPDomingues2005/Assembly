...
CHECK_COLISION PROC ; CHECAR COLISAO = FIM DE JOGO
    ...
    ; MOVEMOS O VALOR DA COR DA COBRA PARA AH
    MOV AH, 0DBh

    ; AQUI IREMOS MOVER A COR DA POSICAO ATUAL DA COBRA
    ; PARA SABER SE ELA COLIDIU
    ...
    CMP AH, AL      
        JE END_GAME ; SE FOREM IGUAIS, HOUVE COLISAO COM O PRÓPRIO CORPO
