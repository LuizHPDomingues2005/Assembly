...
START:
    ...
    MOV DL, '@' ; Define o valor "@" para a cabeça da cobra
    MOV [ES]:SI, DL  ; Armazena o valor da cabeça da cobra na posição atual do ponteiro
...
CHECK_COLLISION:
    ; Obtém o atributo de cor da posição atual
    MOV AH, [ES]:SI+1

    ; Obtém o atributo de cor da cabeça da cobra
    MOV AL, [ES]:1080+1

    ; Compara o atributo de cor atual com o atributo de cor da cabeça da cobra
    CMP AH, AL      
    JE END_GAME ; Se forem iguais, houve colisão com o próprio corpo

    ; Verificar colisão com a parede 
    CMP SI, 004Fh ; Verifica colisão com a parede superior
    JBE END_GAME 
